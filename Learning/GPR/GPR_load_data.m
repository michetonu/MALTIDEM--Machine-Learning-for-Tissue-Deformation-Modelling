function [nn_input,nn_input_compare,nn_output,nn_output_compare] = GPR_load_data(force_node_compare,node_choice)
...
dir_name = strcat(compare_folder,'/Node',num2str(force_node_compare));
